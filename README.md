...
* The program display has just two screens, one to display motor speed and maximum speed and the other one to change the maximum speed, by calling the function **update_screen()** on the main program loop.<br>
<div>
